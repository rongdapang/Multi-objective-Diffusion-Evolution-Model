classdef AdaptiveScheduler < handle
    ...
    methods
        function obj = AdaptiveScheduler(base_ratio, min_ratio, max_ratio)
            ...
            obj.LastBest = inf;
            obj.KnowledgeTransferEnabled = true;
        end
        ...
        function enableKnowledgeTransfer(obj)
            obj.KnowledgeTransferEnabled = true;
        end
        
        function disableKnowledgeTransfer(obj)
            obj.KnowledgeTransferEnabled = false;
        end
    end
end