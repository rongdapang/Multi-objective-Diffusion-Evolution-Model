...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function Population = GenerateInitialSolutions(Algorithm, Problem)
            ...
            nElite = max(1, min(nElite, Problem.N-1));
            nDiverse = Problem.N - nElite;
        ...
        function [GAOffspring, DMOffspring] = GenerateOffspring(Algorithm, Problem, Population)
            ...
            % Ensure at least some GA offspring if nGA > 0
            if nGA > 0 && nGA < 2
                nGA = 2;
                nDM = N - nGA;
            end
            ...
            if nGA > 0
                ...
                % Ensure we have enough parents for tournament selection
